...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Expecting <Bob> Actual <Sue> AddPerson not enqueing correctly, fixed PersonQueue Enqueue function to .Add not Insert
    ...
    // Defect(s) Found: Same issue as Finite repition
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: expecting <tim> actual<Sue>, changed if in GetNextPerson to if Turns <= 0
    ...
    // Defect(s) Found: Expected <tim> actual <sue> same correction as foreverzero made if turns <=0
